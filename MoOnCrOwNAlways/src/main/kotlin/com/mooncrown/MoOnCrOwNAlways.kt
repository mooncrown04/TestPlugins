...
        // Bölüm/Sezon bilgisi yoksa varsayılan olarak 1 atıyoruz
        val finalSeason = season ?: 1
        val finalEpisode = episode ?: 1 
        val isDubbed = isDubbed(item)
        val isSubbed = isSubbed(item)
        
        // *** ÖNEMLİ DÜZELTME: TMDB bölüm verisini sadece TvSeries türünde ve geçerli bölüm varsa çek ***
        val episodeTmdbData = if (tmdbId != null && tmdbType == TvType.TvSeries && episode != null && episode > 0) {
...
            // TMDB'de bölüm adı varsa onu, yoksa temiz başlığı kullan
...
                this.name = if (episodeTmdbData != null && episodeName != itemCleanTitle) {
